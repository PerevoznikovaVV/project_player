...
import 'package:project_player/additionally/audio_progress_bar.dart';
...
class _HomeWidgetState extends State<HomeWidget> {
  late AudioPlayerManagerOne managerOne;

  @override
  void initState() {
    super.initState();
    managerOne = AudioPlayerManagerOne();
    managerOne.init();
  }
  ...
  @override
  Widget build(BuildContext context) {
    return TrackOneScreen(audioPlayerManager: managerOne);
  }
}

class TrackOneScreen extends StatefulWidget {
  const TrackOneScreen({
    Key? key,
  ...
  final AudioPlayerManagerOne audioPlayerManager;
  final String? nameMusic;
  final String? nameAuthor;

  @override
  State<TrackOneScreen> createState() => _TrackOneScreenState(namemusic: nameMusic, nameauthor: nameAuthor);
}

class _TrackOneScreenState extends State<TrackOneScreen> {
  _TrackOneScreenState({this.namemusic,
    this.nameauthor,
  });
  final String? namemusic;
  final String? nameauthor;
            ...
            children: [
              Container(
                  ...
                  child: SizedBox(width: 520,height: 320,
                      child: Image.asset('image/different/track1.jpg', fit: BoxFit.fill,)
                  )
              ),
    ...
    return StreamBuilder<DurationState>(
      ...
      builder: (context, snapshot) {
        ...
        return ProgressBar(
          ...
          bufferedBarColor: Colors.pink[200],
...
class AudioPlayerManagerOne {
  ...
  void init() {
    ...
    player.setUrl('https://www.soundhelix.com/examples/mp3/SoundHelix-Song-7.mp3');
  }
